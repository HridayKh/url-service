...
* The original package name 'in.hridaykh.url-service' is invalid and this project uses 'in.hridaykh.url_service' instead.
...
```
$ docker run --rm -p 8080:8080 url-service:0.0.1-SNAPSHOT
```
