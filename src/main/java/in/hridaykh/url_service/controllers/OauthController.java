...
public class OauthController {
	...
	public String oauthCallback(@PathVariable OauthProviderNames providerName, @RequestParam String code,
		...
		TokenPair tokenPair = oauthService.sessionJwtFromCallback(providerName, code);
		...
		ResponseCookie jwtCookie = ResponseCookie
				...
				.secure(true)
				.path("/")
				// .maxAge(Duration.ofMinutes(15).toSeconds()) // TODO USE FILTER TO HANDLE REFRESH TOKEN
	...
	public String oauthLogout(HttpServletResponse response) {
		ResponseCookie jwtCookie = ResponseCookie
